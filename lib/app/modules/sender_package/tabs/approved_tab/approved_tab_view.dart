...
import 'package:tien_duong/app/modules/sender_package/tabs/approved_tab/approved_tab_item.dart';

class ApprovedTabView extends GetView<ApprovedTabController> {
  const ApprovedTabView({Key? key}) : super(key: key);
  @override
