...
import 'package:tien_duong/app/modules/register/controllers/register_controller.dart';
      ...
      children: [
        ...
        Obx(
          () => ElevatedButton(
              ...
              style: ButtonStyle(
                  backgroundColor: controller.isConfirmPhone.value
                      ? const MaterialStatePropertyAll(AppColors.gray)
                      : const MaterialStatePropertyAll(AppColors.blue),
                  shape: MaterialStatePropertyAll(RoundedRectangleBorder(
