...
import 'delivered_package_item.dart';

class DeliveredPackageView extends GetView<DeliveredPackageController> {
  const DeliveredPackageView({Key? key}) : super(key: key);
  @override
          ...
          child: ListView.separated(
              itemBuilder: (_, index) {
                return Column(
                  ...
                  children: [
                    DeliveredPackageItem(package: controller.dataApis[index]),
                  ],
                );
              },
