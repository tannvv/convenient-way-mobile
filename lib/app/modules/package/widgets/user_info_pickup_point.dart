...
class UserInfoPickupPoint extends StatelessWidget {
  const UserInfoPickupPoint({Key? key, required this.package})
      : super(key: key);
  final Package package;
  @override
  Widget build(BuildContext context) {
    bool isSender = package.sender?.infoUser?.phone == package.pickupPhone;
    String? name = package.pickupName;
    String? phone = package.pickupPhone;
    return Row(
      children: [
        ClipOval(
