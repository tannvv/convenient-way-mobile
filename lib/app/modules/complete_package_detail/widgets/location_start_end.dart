...
class LocationStartEnd extends GetWidget<CompletePackageDetailController> {
  const LocationStartEnd({super.key});
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          //Gap(2.h),
                          _locationItem('Điểm nhận',
                              controller.package.startAddress ?? ''),
                          //Gap(2.h),
                          _locationItem('Điểm giao',
